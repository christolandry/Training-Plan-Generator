...
function firstDirection(){
    ...
    for (let i = 0; i < days.length; i++) {
        days[i].addEventListener('click',() => directionAdder(i));
    }
}
...
function addSteps6(i){
    if (step == 0) {
        ...
        preparePWO(i);
         ...
         if(setSWO(i)){
             prepareSecondaryLongRun(i);
         }
     }else if (step == 3) {
         if(setSecondaryLongRun(i)){
             prepareMR(i);
         }
     }else if (step == 4) {
         if(setMR(i)){
